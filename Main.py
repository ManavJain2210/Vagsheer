...
while True:
    ...
    if flag == 0:
        ...
        flag = 1
    if (x - ( get_x_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled)))>10 or (x -(get_x_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled) ))<-10:
            pi.set_servo_pulsewidth(4, 0) # Maximum throttle.
            ...
            print("Balanced X")
            time.sleep(2)
    if (y - get_y_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled))>10 or (y- get_y_rotation(accel_xout_scaled, accel_yout_scaled, accel_zout_scaled))<-10:
            pi.set_servo_pulsewidth(26, 0) # Maximum throttle.
